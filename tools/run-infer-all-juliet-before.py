...
# Optimize for throughput: use 1 core per infer, maximize parallelism
CORES_PER_JOB = 1
MAX_PARALLEL_JOBS = TOTAL_CORES * 2  # Allow more parallelism with I/O wait
...
def run_case(result_path: str, infer_cmd: str,
    ...
    try:
        ...
        error_log_path = os.path.join(result_path, 'error.log')
        ...
        with open(error_log_path, 'w', encoding='utf-8') as f:
            f.write(f'representative_file: {representative_file}\n')
            f.write(f'command: {infer_cmd}\n')
