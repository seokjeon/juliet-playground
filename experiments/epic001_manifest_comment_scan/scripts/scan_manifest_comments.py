...
from report import inc, new_stats, print_summary
...
def _parse_file(content: str, suffix: str, parsers: dict[str, object]) -> tuple[list[tuple[int, int, str]], list[tuple[int, str, str]], bool]:
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Scan manifest files and append comment_flaw/comment_fix tags.")
    ...
    for file_elem in root.iter("file"):
        ...
        for line_no, tag, code_text, function_name in _match_comments_to_functions(function_spans, comments):
